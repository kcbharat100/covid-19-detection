...
Binary classification has been done by fine tuning VGG19 and MobileNet pretrained model. Accuracy of 98.81% on test data has been achieved in VGG19 whereas 100% in MobileNet.
